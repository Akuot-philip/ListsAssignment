...
fun main() {
    var a =
        findEven(listOf("Akuot", "Philip", "Akuok", "Chol", "saido", "Nyawera", "Cecilia", "Monday", "Philo", "Sudi"))
    println(a)
    var total = heightInmeters(listOf(5, 6, 2, 5))
    println(total)

   var Akuot=Person("Akuot",23,1.5,70)
    var Queenter=Person("Queenter",20,1.4,60)
    var Nkimala=Person("Nkimalatoi",19,1.3,50)
    var Effence=Person("Effence",18,1.2,40)

    var namesOfpeople= listOf(Akuot,Queenter,Nkimala,Effence)
